...
console.error(error);
  ...
  else
  {
    ...
    fetch(base_url+'products?_sort='+this.state.sorting+'&_page='+this.state.page+'&_limit=15', {
...
console.log("final array is=",this.state.allProducts);
  ...
  renderFooter = ()=>{
    return (
      ...
      :null}
{this.state.endOfProducts && 
      <View style={{justifyContent:"center",alignItems:"center",marginBottom:"2%"}}>
        <Text style={{fontSize:18,color:"#FFFF"}}>There are no more products availaible</Text>
      </View>
}
 ...
 <View style={styles.topBarView}><MyTopBar
...
<View style={styles.topBarLine}></View>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.pcikerContainer}>
            ...
            <PickerSelect
            callback={this.picker_selected_value}
            ></PickerSelect>
...
numColumns={2}
             ...
             <TouchableOpacity style={styles.cardView} >
               ...
               <View style={styles.DescriptionView}><Text style={{textAlign:"center",color:"#FFFF"}}>${item.price/100}</Text></View>
               
               
                <View style={styles.DescriptionView}><Text style={{textAlign:"center",color:"#FFFF"}}>{item.date}</Text></View> 
